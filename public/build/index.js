...
(function(root, factory) {
  ...
  _.extend(History.prototype, Events, {
    ...
    checkUrl: function(e) {
      ...
      console.re.log('checkUrl: before current, window.location.hash', window.location.hash);
      console.re.log('checkUrl: current', current);
      console.re.log('checkUrl: window.location.hash', window.location.hash);
    ...
    navigate: function(fragment, options) {
      ...
      // fragment to store history.
          ...
          console.re.log('before 1', window.location.hash);
        this._updateHash(this.location, fragment, options.replace);
          console.re.log('1', window.location.hash);
        if (this.iframe && (fragment !== this.getFragment(this.getHash(this.iframe)))) {
          ...
          console.re.log('1.1', window.location.hash);
        }
...
},{"multiline":5,"underscore":9}],8:[function(require,module,exports){
/**
 * Export `uid`
 */
