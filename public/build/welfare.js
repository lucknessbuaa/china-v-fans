...
var WelfareRouter = Backbone.Router.extend({
    routes: {
        "": "news",
        ":id": "detail"
    },
    ...
    news: function(){
        ...
        wechatshare(_.bind(function(){
            return {
                link: window.location.host + "/welfare",
...
},{"./components/spin.js/spin":10,"backbone":2,"fs":3,"image-sizing":4,"multiline":5,"multpl":7,"uid":8,"underscore":9}],2:[function(require,module,exports){
//     Backbone.js 1.1.2
