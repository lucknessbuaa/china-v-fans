...
},{"strip-indent":5}],5:[function(require,module,exports){
'use strict';
...
},{"multiline":4,"underscore":7}],7:[function(require,module,exports){
//     Underscore.js 1.6.0
...
function loadTpl(path) {
    ...
    return _.template(content.trim());
}
...
var VideoItem = Backbone.View.extend({
    initialize: function(options) {
        var tpl = loadTpl("./tpl/videoItem.html");
...
},{"backbone":1,"image-sizing":2,"multi-download":3,"multiline":4,"multpl":6,"underscore":7}]},{},[8]);
